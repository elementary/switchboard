...
public class Switchboard.SwitchboardApp : Granite.Application {
...
public static int main (string[] args) {
    ...
    context.add_main_entries (Switchboard.SwitchboardApp.entries, "switchboard ");
    ...
    return Switchboard.SwitchboardApp.instance.run (args);
}
