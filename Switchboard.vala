...
public class SettingsApp : Window {
    ...
    private void launch_help () {
        try {
            GLib.Process.spawn_async ("/usr/bin/", {"x-www-browser", "https://answers.launchpad.net/elementaryos"}, null, GLib.SpawnFlags.STDERR_TO_DEV_NULL, null, null);
        } catch {
    ...
    private void launch_translate () {
        try {
            GLib.Process.spawn_async ("/usr/bin/", {"x-www-browser", "https://translations.launchpad.net/elementaryos"}, null, GLib.SpawnFlags.STDERR_TO_DEV_NULL, null, null);
        } catch {
            stderr.printf ("Unable to open link\n");
        }
    }
    ...
    private void launch_report () {
        try {
            GLib.Process.spawn_async ("/usr/bin/", {"x-www-browser", "https://bugs.launchpad.net/elementaryos"}, null, GLib.SpawnFlags.STDERR_TO_DEV_NULL, null, null);
        } catch {
            stderr.printf ("Unable to open link\n");
        }
    }
    ...
    public static int main (string[] args) {
        ...
        Bus.own_name (BusType.SESSION, "org.elementary.SettingsApp", BusNameOwnerFlags.NONE,
              on_bus_aquired,
              () => {},
